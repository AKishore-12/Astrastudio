    ...
    def draw(self):
        st.markdown(
            ...
            <div style="margin-bottom: 20px;">
                <h1 style="font-size:48px; margin-bottom:6px;">🚀 Kickoff!</h1>
        ...
        st.markdown(
            ...
            ">
                ...
                <ul style="margin-top:8px; padding-left:18px; opacity:0.9;">
                    <li>Agents collaborate based on the crew configuration</li>
                    <li>Tasks are executed in sequence or in parallel</li>
                    <li>Tools and knowledge sources are invoked as needed</li>
                    <li>Console output and intermediate steps are captured</li>
                    <li>Final and task-level results are stored for review</li>
                </ul>
            </div>
            """,
            unsafe_allow_html=True,
