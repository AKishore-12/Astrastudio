    ...
    def draw(self):
        st.markdown(
            ...
            <div style="margin-bottom: 20px;">
                <h1 style="font-size:48px; margin-bottom:6px;">📦 Import / Export</h1>
                <p style="font-size:18px; opacity:0.75;">
                    Import and export crews, configurations, and results. This allows you to back up
                    your work, share crews with others, or deploy a crew as a standalone application.
                </p>
            </div>
            """,
        ...
        st.markdown(
            ...
            ">
                ...
                <ul style="margin-top:8px; padding-left:18px; opacity:0.9;">
                    <li>Export all crews as a JSON backup</li>
                    <li>Import crews or full databases from JSON files</li>
                    <li>Export a single crew as a standalone Streamlit app</li>
                    <li>Share or deploy crews outside Astrastudio</li>
                </ul>
            </div>
            """,
            unsafe_allow_html=True,
